...
_Captured 2026-06-02_

| Component | Version / SHA | Source |
|-----------|--------------|--------|
...
| uv | 0.10.4 | `uv --version` |
| node | 25.5.0 | `node --version` |
| Python (venv) | 3.11.14 | hermes --version output |
| Python (system) | 3.14.5 | `python3 --version` |
